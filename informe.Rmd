...
# CERTIFICADO DE ACCIONES SUDMEDICA QUILLOTA S.A
**CESAR GERÓNIMO MENDOZA DEVIA**, Gerente General de Sudmédica Quillota S.A., Rut: 76.912.075-0, viene a certificar que don(ña) **`r nombre_persona`**, Rut **`r params$rut`**, es accionista de esta empresa, con una cantidad total de **`r sum(tabla_final$q_acciones)`** acciones. La tabla de resumen de su(s) contratos se puede encontrar a continuación:
\
...
\begin{center}CESAR GERÓNIMO MENDOZA DEVIA\end{center}
